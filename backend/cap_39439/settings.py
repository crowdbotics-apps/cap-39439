"""
Django settings for cap_39439 project.
...
WSGI_APPLICATION = 'cap_39439.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cap_39439 API",
    "DESCRIPTION": "API documentation for cap_39439 App",
    "VERSION": "v1",
}
